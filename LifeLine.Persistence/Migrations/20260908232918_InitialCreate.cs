        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetEntityId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalCondition = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    ...
                    IsAccountNameResolved = table.Column<bool>(type: "boolean", nullable: false),
                    SubAccountCode = table.Column<string>(type: "text", nullable: true),
                    PaystackSubaccountIsVerified = table.Column<bool>(type: "boolean", nullable: false),
                    PaystackSubaccountIsActive = table.Column<bool>(type: "boolean", nullable: false),
                    IsPaymentReady = table.Column<bool>(type: "boolean", nullable: false),
                    PaymentSetupErrorMessage = table.Column<string>(type: "text", nullable: true),
                    PaymentActivatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVerified = table.Column<bool>(type: "boolean", nullable: false),
                    DonorSequenceNumber = table.Column<int>(type: "integer", nullable: false),
                    WasRoutedToPlatform = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PerformedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    PostedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    VerifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalDocument_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalUpdate", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalUpdate_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportMessages_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalDocument_CampaignId",
                table: "MedicalDocument",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalUpdate_CampaignId",
                table: "MedicalUpdate",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportMessages_CampaignId",
